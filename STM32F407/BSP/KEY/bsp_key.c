...
void KEY_1_IRQHANDLER(void)
{
    ...
    printf("按键 KEY_1 触发.\r");                                 // 重要提示：printf是不可重入函数，不建议在中断服务函数中使用printf: 可能会产生不可预测的错误。这里使用printf，只用代码测试使用！！
}
...
{ 
    ...
    LED_RED_TOGGLE;                                               // 反转红色LED
    printf("按键 KEY_2 触发.\r");                                 // 重要提示：printf是不可重入函数，不建议在中断服务函数中使用printf: 可能会产生不可预测的错误。这里使用printf，只用代码测试使用！！    
}
...
void KEY_3_IRQHANDLER(void)
{
    ...
    LED_RED_TOGGLE;                                               // 反转红色LED
    printf("按键 KEY_3 触发.\r");                                 // 重要提示：printf是不可重入函数，不建议在中断服务函数中使用printf: 可能会产生不可预测的错误。这里使用printf，只用代码测试使用！！   
}
